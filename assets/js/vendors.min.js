      ...
      function (e, t, n) {
        ...
        function r() {
          if (
            ...
            return (v = (0, p.default)(v, y)), (0, f.default)(v, y.once), v;
        }
        function o() {
          (v = (0, h.default)()), r();
        }
            ...
            return !0 === (t = y.disable) ||
              ...
              : (y.disableMutationObserver ||
                ...
                window.addEventListener(
                  "resize",
                  (0, l.default)(r, y.debounceDelay, !0)
                ),
                window.addEventListener(
                  "orientationchange",
                  (0, l.default)(r, y.debounceDelay, !0)
        ...
        (function (e) {
          ...
          function o(i, r, e) {
            function o(e) {
              var t = l,
                n = u;
              return (l = u = void 0), (v = e), (f = i.apply(n, t));
            }
            function a(e) {
              var t = e - h;
            ...
            function s() {
              ...
              return a(n)
                ...
                : void (p = setTimeout(
                    s,
                    ((t = r - ((e = n) - h)), y ? k(t, d - (e - v)) : t)
                  ));
            }
            function c(e) {
              return (p = void 0), n && l ? o(e) : ((l = u = void 0), f);
            }
            function t() {
              var e,
                t = _(),
                n = a(t);
              if (((l = arguments), (u = this), (h = t), n)) {
                if (void 0 === p)
                  return (v = e = h), (p = setTimeout(s, r)), m ? o(e) : f;
                if (y) return (p = setTimeout(s, r)), o(h);
              }
              return void 0 === p && (p = setTimeout(s, r)), f;
            }
            var l,
              u,
              d,
            ...
            return (
              ...
              (t.cancel = function () {
                void 0 !== p && clearTimeout(p), (l = h = u = p = void (v = 0));
              }),
              (t.flush = function () {
  ...
  (function (e, t) {
          ...
          if (null != (e = arguments[s]))
            for (t in e)
              (i = e[t]),
                "__proto__" !== t &&
                  a !== i &&
                  (l && i && (A.isPlainObject(i) || (r = Array.isArray(i)))
                    ? ((n = a[t]),
                      (o =
                        r && !Array.isArray(n)
                          ? []
    ...
    var p = (function (n) {
      ...
      function se(t, e, n, i) {
        ...
        if (!i && (k(e), (e = e || _), A)) {
          ...
          if (
            ...
            if (((u = t), (d = e), 1 === f && (J.test(t) || X.test(t)))) {
              for (
        ...
        return (
          i != _ &&
            ...
            (p.scope = ue(function (e) {
              return (
                s.appendChild(e).appendChild(_.createElement("div")),
            ...
            (u = []),
            (m = []),
            (p.qsa = ee.test(_.querySelectorAll)) &&
              (ue(function (e) {
                var t;
              ...
              ? function (e, t) {
                  ...
                  return (
                    ...
                    (!p.sortDetached && t.compareDocumentPosition(e) === n)
                      ? e == _ || (e.ownerDocument == b && g(b, e))
                        ? -1
                        : t == _ || (t.ownerDocument == b && g(b, t))
                        ? 1
                        : c
                        ? z(c, e) - z(c, t)
                        : 0
      ...
      (se.contains = function (e, t) {
        return (e.ownerDocument || e) != _ && k(e), g(e, t);
      }),
            ...
            return 1 === v && 0 === m
              ...
              : function (e, t, n) {
                  var i,
                    ...
                    s,
                    c,
                    l = y != g ? "nextSibling" : "previousSibling",
                    u = e.parentNode,
                  ...
                  if (u) {
                    ...
                    if (((c = [g ? u.firstChild : u.lastChild]), g && f)) {
                      for (
                        p =
                          (s =
                            (i =
      ...
      function xe(s, e, t) {
        ...
        return e.first
          ? function (e, t, n) {
              for (; (e = e[c]); ) if (1 === e.nodeType || d) return s(e, t, n);
              return !1;
            }
          : function (e, t, n) {
              var i,
        ...
        return (
          ...
          le(function (e, t, n, i) {
            var r,
              ...
              d = !p || (!e && h) ? u : ke(u, s, p, n, i),
              f = v ? (y || (e ? p : l || m) ? [] : t) : d;
            if ((v && v(d, f, n, i), m))
              for (r = ke(f, c), m(r, [], n, i), o = r.length; o--; )
                (a = r[o]) && (f[c[o]] = !(d[c[o]] = a));
            if (e) {
              if (y || p) {
                if (y) {
            ...
            } else (f = ke(f === t ? f.splice(l, f.length) : f)), y ? y(null, t, f, i) : O.apply(t, f);
          })
        );
      }
      function Ae(e) {
        for (
          var r,
            ...
            u = [
              function (e, t, n) {
                var i =
                  (!o && (n || t !== w)) || ((r = t).nodeType ? c : l)(e, t, n);
                return (r = null), i;
              },
            ];
          s < i;
      ...
      function Te(m, y) {
        function e(e, t, n, i, r) {
          ...
          for (
            ...
            if (b && o) {
              for (
                a = 0, t || o.ownerDocument == _ || (k(o), (n = !A));
                (s = m[a++]);
            ...
            g && ((o = !s && o) && c--, e && u.push(o));
          }
          if (((c += l), g && l !== c)) {
            for (a = 0; (s = y[a++]); ) s(u, d, t, n);
            if (e) {
              if (0 < c) for (; l--; ) u[l] || d[l] || (d[l] = q.call(i));
              d = ke(d);
            }
            O.apply(i, d),
    ...
    (A.filter = function (e, t, n) {
      ...
      A.fn.extend({
        ...
        is: function (e) {
          return !!N(
            this,
            "string" == typeof e && C.test(e) ? A(e) : e || [],
            !1
          ).length;
        },
      });
    ...
    ((A.fn.init = function (e, t, n) {
      ...
      if (i[1]) {
        if (
          ...
          A.merge(
            this,
            A.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : w, !0)
          ),
      ...
      return (
        (r = w.getElementById(i[2])) && ((this[0] = r), (this.length = 1)), this
      );
    }).prototype = A.fn),
      (D = A(w));
        ...
        function (i, r) {
          A.fn[i] = function (e, t) {
            ...
            return (
              ...
              1 < this.length &&
                (q[i] || A.uniqueSort(n), L.test(i) && n.reverse()),
              this.pushStack(n)
            );
          };
        }
    ...
    (A.Callbacks = function (i) {
      ...
      A.extend({
                    ...
                    function e() {
                      ...
                      if (!(r < c)) {
                        ...
                        (t =
                          ...
                          x(t)
                            ? s
                              ? t.call(e, l(c, o, P, s), l(c, o, z, s))
                              : (c++,
                                t.call(
                                  e,
                                  l(c, o, P, s),
                                  l(c, o, z, s),
                                  l(c, o, P, o.notifyWith)
                                ))
                            : (a !== P && ((n = void 0), (i = [e])),
                              (s || o.resolveWith)(n, i));
                      }
        ...
        when: function (e) {
          ...
          if (
            n <= 1 &&
            (I(e, a.done(t(i)).resolve, a.reject, !n),
    ...
    (A.Deferred.exceptionHook = function (e, t) {
      v.console &&
        ...
        e &&
        R.test(e.name) &&
        v.console.warn("jQuery.Deferred exception: " + e.message, e.stack, t);
    }),
    ...
    A.extend({
      ...
      A.fn.extend({
        data: function (n, e) {
          ...
          if (
            this.length &&
            ((r = Q.get(o)), 1 === o.nodeType && !V.get(o, "hasDataAttrs"))
          ) {
            for (t = a.length; t--; )
              a[t] &&
    ...
    function ae(e, t) {
      return (
        ...
        ("" === e.style.display && re(e) && "none" === A.css(e, "display"))
      );
    }
    var se = {};
    function ce(e, t) {
    ...
    function ge(e, t, n, i, r) {
      for (
        ...
        if ((o = e[p]) || 0 === o)
          if ("object" === _(o)) A.merge(f, o.nodeType ? [o] : o);
          else if (ye.test(o)) {
            for (
              ...
              a = a.lastChild;
            A.merge(f, a.childNodes), ((a = d.firstChild).textContent = "");
          } else f.push(t.createTextNode(o));
      for (d.textContent = "", p = 0; (o = f[p++]); )
        if (i && -1 < A.inArray(o, i)) r && r.push(o);
        else if (
          ((l = re(o)), (a = ve(d.appendChild(o), "script")), l && me(a), n)
        )
          ...
          A.event.add(e, r, {
            ...
            handler: function (e) {
              ...
              if (1 & e.isTrigger && this[r]) {
                if (i.length)
                  (A.event.special[r] || {}).delegateType &&
                    e.stopPropagation();
                else if (
                  ((i = s.call(arguments)),
                  V.set(this, r, i),
                ...
                i.length &&
                  (V.set(this, r, {
                    value: A.event.trigger(
                      A.extend(i[0], A.Event.prototype),
                      i.slice(1),
                      this
                    ),
                  }),
    ...
    (A.event = {
            ...
            (p = v = (s = we.exec(e[l]) || [])[1]),
              ...
              p &&
                ...
                (f = c[p]) ||
                  ...
                  (d.setup && !1 !== d.setup.call(t, i, h, a)) ||
            ...
            if (
              ...
              a &&
                ...
                ((d.teardown && !1 !== d.teardown.call(e, h, m.handle)) ||
                  A.removeEvent(e, p, m.handle),
                delete c[p]);
            } else for (p in c) A.event.remove(e, p + t[l], n, i, !0);
      ...
      dispatch: function (e) {
        var t,
          ...
          c = A.event.fix(e),
          l = (V.get(this, "events") || Object.create(null))[c.type] || [],
          u = A.event.special[c.type] || {};
        ...
        if (
          ...
          for (
            a = A.event.handlers.call(this, c, l), t = 0;
      ...
      special: {
        ...
        click: {
          setup: function (e) {
            var t = this || e;
            return (
              de.test(t.type) && t.click && E(t, "input") && Ce(t, "click", ke),
              !1
            );
          },
          trigger: function (e) {
            var t = this || e;
            return (
              de.test(t.type) && t.click && E(t, "input") && Ce(t, "click"), !0
            );
          },
          _default: function (e) {
            var t = e.target;
    ...
    function qe(e, t) {
      ...
      if (1 === t.nodeType) {
        if (V.hasData(e) && (s = V.get(e).events))
          for (r in (V.remove(t, "handle events"), s))
            for (n = 0, i = s[r].length; n < i; n++) A.event.add(t, r, s[r][n]);
        Q.hasData(e) && ((o = Q.access(e)), (a = A.extend({}, o)), Q.set(t, a));
      }
    }
    function Me(n, i, r, o) {
      i = y(i);
      ...
      if (
        ...
        for (s = (a = A.map(ve(e, "script"), je)).length; u < d; u++)
          (c = e),
            u !== f &&
              ((c = A.clone(c, !0, !0)), s && A.merge(a, ve(c, "script"))),
            r.call(n[u], c, u);
        if (s)
          for (
            l = a[a.length - 1].ownerDocument, A.map(a, Le), u = 0;
            u < s;
            u++
          )
            (c = a[u]),
              pe.test(c.type || "") &&
                ...
                (c.src && "module" !== (c.type || "").toLowerCase()
                  ...
                  : k(c.textContent.replace(Ne, ""), c, l));
      }
      return n;
    }
    function Oe(e, t, n) {
    ...
    A.extend({
      ...
      clone: function (e, t, n) {
        ...
        if (
          ...
          for (a = ve(u), i = 0, r = (o = ve(e)).length; i < r; i++)
            (s = o[i]),
              (c = a[i]),
              "input" === (l = c.nodeName.toLowerCase()) && de.test(s.type)
                ? (c.checked = s.checked)
                : ("input" !== l && "textarea" !== l) ||
        ...
        if (t)
          if (n)
            for (
              o = o || ve(e), a = a || ve(u), i = 0, r = o.length;
              i < r;
              i++
            )
              qe(o[i], a[i]);
        ...
        return (
          0 < (a = ve(u, "script")).length && me(a, !d && ve(e, "script")), u
        );
      },
      cleanData: function (e) {
        for (
          var t, n, i, r = A.event.special, o = 0;
          void 0 !== (n = e[o]);
          o++
        )
          if (J(n)) {
      ...
      A.fn.extend({
        ...
        empty: function () {
          for (var e, t = 0; null != (e = this[t]); t++)
            1 === e.nodeType && (A.cleanData(ve(e, !1)), (e.textContent = ""));
          return this;
        },
        clone: function (e, t) {
          return (
            ...
            function (e) {
              ...
              if (
                ...
                try {
                  for (; n < i; n++)
                    1 === (t = this[n] || {}).nodeType &&
                      (A.cleanData(ve(t, !1)), (t.innerHTML = e));
                  t = 0;
                } catch (e) {}
              }
        ...
        replaceWith: function () {
          ...
          return Me(
            ...
            function (e) {
              ...
              A.inArray(this, n) < 0 &&
                (A.cleanData(ve(this)), t && t.replaceChild(e, this));
            },
            n
          );
        },
    ...
    function lt(e, t, n, i, r, o) {
      ...
      for (; a < 4; a += 2)
        "margin" === n && (c += A.css(e, n + ne[a], !0, r)),
          i
            ? ("content" === n && (c -= A.css(e, "padding" + ne[a], !0, r)),
              "margin" !== n &&
                (c -= A.css(e, "border" + ne[a] + "Width", !0, r)))
            : ((c += A.css(e, "padding" + ne[a], !0, r)),
              "padding" !== n
                ? (c += A.css(e, "border" + ne[a] + "Width", !0, r))
                : (s += A.css(e, "border" + ne[a] + "Width", !0, r)));
      return (
        !i &&
          0 <= o &&
          (c +=
    ...
    function ut(e, t, n) {
      ...
      return (
        ((!b.boxSizingReliable() && r) ||
          (!b.reliableTrDimensions() && E(e, "tr")) ||
          "auto" === a ||
          (!parseFloat(a) && "inline" === A.css(e, "display", !1, i))) &&
          e.getClientRects().length &&
          ((r = "border-box" === A.css(e, "boxSizing", !1, i)),
          (o = s in e) && (a = e[s])),
        (a = parseFloat(a) || 0) +
          lt(e, t, n || (r ? "border" : "content"), o, i, a) +
          "px"
      );
    }
    A.extend({
      ...
      A.each(["height", "width"], function (e, c) {
        A.cssHooks[c] = {
          get: function (e, t, n) {
            if (t)
              return !rt.test(A.css(e, "display")) ||
          ...
          set: function (e, t, n) {
            var i,
              ...
              a = (o || n) && "border-box" === A.css(e, "boxSizing", !1, r),
              s = n ? lt(e, c, n, a, r) : 0;
            return (
              a &&
                o &&
                (s -= Math.ceil(
                  e["offset" + c[0].toUpperCase() + c.slice(1)] -
                    parseFloat(r[c]) -
                    lt(e, c, "border", !1, r) -
                    0.5
                )),
      ...
      A.each({ margin: "", padding: "", border: "Width" }, function (r, o) {
        (A.cssHooks[r + o] = {
          expand: function (e) {
            for (
            ...
            return void 0 === e.getAttribute
              ...
              : ((1 === o && A.isXMLDoc(e)) ||
                  (r =
                    ...
                    (A.expr.match.bool.test(t) ? dt : void 0)),
                void 0 !== n
                  ? null === n
      ...
      A.extend({
        prop: function (e, t, n) {
          ...
          if (3 !== o && 8 !== o && 2 !== o)
            return (
              (1 === o && A.isXMLDoc(e)) ||
                ((t = A.propFix[t] || t), (r = A.propHooks[t])),
              void 0 !== n
                ? r && "set" in r && void 0 !== (i = r.set(e, n, t))
                  ? i
                  : (e[t] = n)
        ...
        toggleClass: function (r, t) {
          ...
          return "boolean" == typeof t && a
            ...
            : this.each(function () {
                var e, t, n, i;
                if (a)
                  for (t = 0, n = A(this), i = yt(r); (e = i[t++]); )
                    n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
                else
                  (void 0 !== r && "boolean" != o) ||
                    ((e = mt(this)) && V.set(this, "__className__", e),
                    this.setAttribute &&
                      this.setAttribute(
                        "class",
        ...
        return arguments.length
          ? ((r = x(n)),
            this.each(function (e) {
              var t;
              1 === this.nodeType &&
                (null == (t = r ? n.call(this, e, A(this).val()) : n)
                  ? (t = "")
                  : "number" == typeof t
                  ? (t += "")
                  : Array.isArray(t) &&
          ...
          : t
          ? (i = A.valHooks[t.type] || A.valHooks[t.nodeName.toLowerCase()]) &&
            "get" in i &&
          ...
          select: {
            ...
            set: function (e, t) {
              for (
                ...
                ((i = r[a]).selected =
                  -1 < A.inArray(A.valHooks.option.get(i), o)) && (n = !0);
    ...
    A.extend(A.event, {
      trigger: function (e, t, n, i) {
        ...
        if (
          ...
          3 !== n.nodeType &&
            8 !== n.nodeType &&
            !xt.test(p + A.event.triggered) &&
            (-1 < p.indexOf(".") &&
              ((p = (h = p.split(".")).shift()), h.sort()),
            (c = p.indexOf(":") < 0 && "on" + p),
            ((e = e[A.expando]
              ? e
              : new A.Event(p, "object" == typeof e && e)).isTrigger = i
              ? 2
              : 3),
            (e.namespace = h.join(".")),
          ...
          if (!i && !u.noBubble && !m(n)) {
            for (
              s = u.delegateType || p, xt.test(s + p) || (o = o.parentNode);
              o;
              o = o.parentNode
            )
              f.push(o), (a = o);
            a === (n.ownerDocument || w) &&
              f.push(a.defaultView || a.parentWindow || v);
          }
      ...
      simulate: function (e, t, n) {
        var i = A.extend(new A.Event(), n, { type: e, isSimulated: !0 });
      ...
      b.focusin ||
        A.each({ focus: "focusin", blur: "focusout" }, function (n, i) {
          function r(e) {
    ...
    (A.param = function (e, t) {
      ...
      (b.createHTMLDocument =
        (((wt = w.implementation.createHTMLDocument("").body).innerHTML =
          "<form></form><form></form>"),
          ...
          if (this[0]) {
            ...
            if ("fixed" === A.css(i, "position")) t = i.getBoundingClientRect();
              ...
              e &&
                e !== i &&
                1 === e.nodeType &&
                (((r = A(e).offset()).top += A.css(e, "borderTopWidth", !0)),
      ...
      A.each(["top", "left"], function (e, n) {
        A.cssHooks[n] = Ge(b.pixelPosition, function (e, t) {
          if (t)
            return (t = Qe(e, n)), Ue.test(t) ? A(e).position()[n] + "px" : t;
        });
      }),
    ...
    return (
      (A.noConflict = function (e) {
        return (
          v.$ === A && (v.$ = Nt), e && v.jQuery === A && (v.jQuery = St), A
        );
      }),
  ...
  t && Object.deepExtend(p, t),
    ...
    (p.fn.particle = function (e, t, n) {
      if (
        ...
        if (e.value instanceof Array) {
          var i =
            e.value[Math.floor(Math.random() * p.particles.color.value.length)];
    ...
    (p.fn.particle.prototype.draw = function () {
      ...
      if (e.color.rgb)
        ...
        i =
          ...
          ")";
      switch (
        ((p.canvas.ctx.fillStyle = i), p.canvas.ctx.beginPath(), e.shape)
      ) {
        case "circle":
        ...
        case "polygon":
          p.fn.vendors.drawShape(
            p.canvas.ctx,
            e.x - t / (p.particles.shape.polygon.nb_sides / 3.5),
            e.y - t / 0.76,
            (2.66 * t) / (p.particles.shape.polygon.nb_sides / 3),
        ...
        case "star":
          p.fn.vendors.drawShape(
            p.canvas.ctx,
            e.x - (2 * t) / (p.particles.shape.polygon.nb_sides / 4),
            e.y - t / 1.52,
            (2 * t * 2.66) / (p.particles.shape.polygon.nb_sides / 3),
            p.particles.shape.polygon.nb_sides,
            2
          );
          break;
    ...
    (p.fn.particlesUpdate = function () {
      for (var e = 0; e < p.particles.array.length; e++) {
        ...
        if (
          (p.particles.opacity.anim.enable &&
            (1 == t.opacity_status
              ? (t.opacity >= p.particles.opacity.value &&
                  (t.opacity_status = !1),
                (t.opacity += t.vo))
              : (t.opacity <= p.particles.opacity.anim.opacity_min &&
                  (t.opacity_status = !0),
                (t.opacity -= t.vo)),
            t.opacity < 0 && (t.opacity = 0)),
          p.particles.size.anim.enable &&
            (1 == t.size_status
              ? (t.radius >= p.particles.size.value && (t.size_status = !1),
                (t.radius += t.vs))
              : (t.radius <= p.particles.size.anim.size_min &&
                  (t.size_status = !0),
                (t.radius -= t.vs)),
        ...
        switch (
          (t.x - t.radius > p.canvas.w
            ? ((t.x = i.x_left), (t.y = Math.random() * p.canvas.h))
            : t.x + t.radius < 0 &&
              ((t.x = i.x_right), (t.y = Math.random() * p.canvas.h)),
          t.y - t.radius > p.canvas.h
            ? ((t.y = i.y_top), (t.x = Math.random() * p.canvas.w))
            : t.y + t.radius < 0 &&
              ((t.y = i.y_bottom), (t.x = Math.random() * p.canvas.w)),
          p.particles.move.out_mode)
        ) {
          case "bounce":
            (t.x + t.radius > p.canvas.w || t.x - t.radius < 0) &&
              (t.vx = -t.vx),
              (t.y + t.radius > p.canvas.h || t.y - t.radius < 0) &&
                (t.vy = -t.vy);
        }
        if (
          (isInArray("grab", p.interactivity.events.onhover.mode) &&
            p.fn.modes.grabParticle(t),
          (isInArray("bubble", p.interactivity.events.onhover.mode) ||
            isInArray("bubble", p.interactivity.events.onclick.mode)) &&
            p.fn.modes.bubbleParticle(t),
          (isInArray("repulse", p.interactivity.events.onhover.mode) ||
            isInArray("repulse", p.interactivity.events.onclick.mode)) &&
            p.fn.modes.repulseParticle(t),
          ...
          for (var r = e + 1; r < p.particles.array.length; r++) {
            ...
            p.particles.line_linked.enable && p.fn.interact.linkParticles(t, o),
              p.particles.move.attract.enable &&
                p.fn.interact.attractParticles(t, o),
    ...
    (p.fn.modes.bubbleParticle = function (s) {
      if (
        ...
        if (c <= p.interactivity.modes.bubble.distance) {
          if (0 <= n && "mousemove" == p.interactivity.status) {
            if (p.interactivity.modes.bubble.size != p.particles.size.value)
              if (p.interactivity.modes.bubble.size > p.particles.size.value) {
                0 <= (o = s.radius + p.interactivity.modes.bubble.size * n) &&
                  (s.radius_bubble = o);
              } else {
            ...
            if (
              ...
              if (
                ...
                (a = p.interactivity.modes.bubble.opacity * n) > s.opacity &&
                  a <= p.interactivity.modes.bubble.opacity &&
                  (s.opacity_bubble = a);
              else
                (a =
                  s.opacity -
        ...
        if (p.tmp.bubble_clicking) {
          ...
          l > p.interactivity.modes.bubble.duration &&
            (p.tmp.bubble_duration_end = !0),
            l > 2 * p.interactivity.modes.bubble.duration &&
            ...
            if (p.tmp.bubble_duration_end)
              null != n &&
                ((a =
                  ...
                  (e -
                    (i -
                      (l * (i - e)) / p.interactivity.modes.bubble.duration))),
              ...
              if (o != e) {
                var a =
                  i - (l * (i - e)) / p.interactivity.modes.bubble.duration;
                "size" == r && (s.radius_bubble = a),
                  "opacity" == r && (s.opacity_bubble = a);
              }
            } else
    ...
    (p.fn.modes.repulseParticle = function (i) {
      if (
        ...
        var e = i.x - p.interactivity.mouse.pos_x,
          ...
          o = t / n,
          a = clamp(
            (1 / (c = p.interactivity.modes.repulse.distance)) *
              (-1 * Math.pow(n / c, 2) + 1) *
              c *
              100,
            0,
          ...
          s = { x: i.x + r * a, y: i.y + o * a };
        "bounce" == p.particles.move.out_mode
          ? (0 < s.x - i.radius && s.x + i.radius < p.canvas.w && (i.x = s.x),
            0 < s.y - i.radius && s.y + i.radius < p.canvas.h && (i.y = s.y))
          : ((i.x = s.x), (i.y = s.y));
      } else if (
        p.interactivity.events.onclick.enable &&
        isInArray("repulse", p.interactivity.events.onclick.mode)
          ...
          d <= c &&
            (function () {
              ...
              if (
                ...
                var t = i.x + i.vx,
                  n = i.y + i.vy;
                (t + i.radius > p.canvas.w || t - i.radius < 0) &&
                  (i.vx = -i.vx),
                  (n + i.radius > p.canvas.h || n - i.radius < 0) &&
                    (i.vy = -i.vy);
              }
            })();
        } else
          0 == p.tmp.repulse_clicking && ((i.vx = i.vx_i), (i.vy = i.vy_i));
    }),
    ...
    (p.fn.vendors.densityAutoParticles = function () {
      if (p.particles.number.density.enable) {
        ...
        n < 0
          ? p.fn.modes.pushParticles(Math.abs(n))
          : p.fn.modes.removeParticles(n);
      }
    }),
    (p.fn.vendors.checkOverlap = function (e, t) {
      for (var n = 0; n < p.particles.array.length; n++) {
        var i = p.particles.array[n],
          r = e.x - i.x,
          o = e.y - i.y;
        Math.sqrt(r * r + o * o) <= e.radius + i.radius &&
    ...
    (p.fn.vendors.destroypJS = function () {
      cancelAnimationFrame(p.fn.drawAnimFrame), n.remove(), (pJSDom = null);
    }),
...
(Object.deepExtend = function (e, t) {
  ...
  (window.particlesJS = function (e, t) {
    ...
    if (r.length) for (; 0 < r.length; ) n.removeChild(r[0]);
